#ifndef GLFWWRAPPER_ENUMS_HPP
#define GLFWWRAPPER_ENUMS_HPP
...
namespace glfw
{
    ...
    [[nodiscard]] inline const char* getKeyName(KeyCode key_)
    {
        return glfwGetKeyName(static_cast<int>(key_), 0);
    }
    [[nodiscard]] inline int getKeyScanCode(KeyCode key_)
    {
        return glfwGetKeyScancode(static_cast<int>(key_));
    }
    ...
    GLFWWRAPPER_ENUM_BITS_OPERATORS(ModifierKeyBit)
